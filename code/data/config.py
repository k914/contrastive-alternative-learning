...
_C.INPUT_SIZE = 640
_C.STEPS = [4, 8, 16, 32, 64, 128, 256]
_C.ANCHOR_SIZES1 = [8, 16, 32, 64, 128, 256, 512]
...
# face config
_C.FACE = EasyDict()
_C.FACE.TRAIN_FILE = 'E:/hj/coSSD/models/data/face_train2.txt'
_C.FACE.VAL_FILE = 'E:/hj/coSSD/models/data/face_train2.txt'
_C.FACE.FDDB_DIR = '/home/lijun/data/FDDB'
_C.FACE.WIDER_DIR = 'E:/data/FaceDetection/WIDER'
